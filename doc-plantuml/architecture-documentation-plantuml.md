...
# What2Eat - Architecture documentation (PlantUML) <!-- omit in toc -->
...
In this version, all the diagrams have been generated with [PlantUML](https://plantuml.com/) using the [adf-plantuml](https://github.com/architecture-decomposition-framework/adf-plantuml/)-template. If you're interested in the PlantUML-Source-Code, have a look at [this version](architecture-documentation-plantuml-source.md).

Some of the diagrams are based on preliminary work by Yan-Chun Chang in her Bachelor's thesis with the (German) title "Wie gut eignen sich die textbasierte Diagrammerstellungssprache PlantUML zur Erstellung von Architektur-Diagrammen nach der ADF-Methode im Vergleich zur Erstellung mit Diagrams.net?", HTWG Konstanz, University of Applied Science, 2024.
...
![system-context-RT](generated/system-context-RT.png)
...
![domain-model-RT](generated/domain-model-RT.png)
...
![coarse-functional-decomposition-RT](generated/coarse-functional-decomposition-RT.png)
...
![system-structure-RT](generated/system-structure-RT.png)
...
![system-data-RT](generated/system-data-RT.png)
...
![functional-driven-decomposition-services-RT](generated/functional-driven-decomposition-services-RT.png)

_Figure: Service dependencies (Functions@Runtime)_

-----

![functional-driven-decomposition-backend-DT](generated/functional-driven-decomposition-backend-DT.png)
...
![deployment-driven-decomposition-DT](generated/deployment-driven-decomposition-DT.png)
...
![deployment-driven-decomposition-RT](generated/deployment-driven-decomposition-RT.png)
...
![systems-technology-selection-RT](generated/systems-technology-selection-RT.png)
...
![implementation-di-factory-DT](generated/implementation-di-factory-DT.png)
...
![implementation-cache-di-factory-DT](generated/implementation-cache-di-factory-DT.png)
...
![behavior-cache-miss-RT](generated/behavior-cache-miss-RT.png)
...
![behavior-cache-hit-RT](generated/behavior-cache-hit-RT.png)
